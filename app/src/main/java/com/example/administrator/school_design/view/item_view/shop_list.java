...
public class shop_list extends Activity  implements OnBannerItemClickListener , GradationScrollView.ScrollViewListener{
    ...
    private Activity activity=shop_list.this;
        ...
        shop_car.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ( AnimShopButton.mCount==0){
                    Toast.makeText(shop_list.this,"请选择购买数量",Toast.LENGTH_SHORT).show();
                }else {
                    showpopwindow();
                }
    ...
    private void initListeners() {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(shop_list.this);
            }
        });
    }
    ...
    private void showpopwindow() {
        ...
        save_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (named.equals("")){
                    Toast.makeText(shop_list.this,"请输入收件姓名",Toast.LENGTH_SHORT).show();
                }else if (phone.equals("")){
                    Toast.makeText(shop_list.this,"请输入收件电话",Toast.LENGTH_SHORT).show();
                }else if (address.equals("")){
                    Toast.makeText(shop_list.this,"请输入收件地址",Toast.LENGTH_SHORT).show();
                }else {
                    pd = ProgressDialog.show(shop_list.this, null, "正在下单，请稍候...");
                    ...
                    query.findObjects(new FindListener<my_shop_1>() {
                        @Override
                        public void done(List<my_shop_1> list, BmobException e) {
                                        ...
                                        public void done(BmobException e) {
                                            ...
                                            Score1.update(id, new UpdateListener() {
                                                ...
                                                public void done(BmobException e) {
                                                    if(e==null){
                                                        pd.dismiss();
                                                        Toast.makeText(shop_list.this,"购买成功" ,Toast.LENGTH_SHORT).show();
                                                        Log.i("上传","成功");
                                                        mPopupWindow.dismiss();
                                                    }
                                                }
    ...
    private void initloop() {
        ...
        mLoopViewPagerLayout1.setLoop_ms(1000000);//轮播的速度(毫秒)
        mLoopViewPagerLayout1.setIndicatorLocation(IndicatorLocation.Center);//指示器位置-中Center
        mLoopViewPagerLayout1.setLoop_style(LoopStyle.Depth);//轮播的样式-深度depth
        ...
        //TODO 初始化
        mLoopViewPagerLayout1.initializeData(this);
    ...
    private void addshop() {
        bannerInfos.clear();
        String tap=getIntent().getStringExtra("shop_list");
    ...
    public void onScrollChanged(GradationScrollView scrollView, int x, int y, int oldx, int oldy) {
        ...
        if (y <= 0) {   //设置标题的背景颜色
            ...
            tvGoodTitle.setTextColor(Color.argb(0, 1,24,28));
