...
public class HeadZoomScrollView extends ScrollView {
    ...
    //    最大的放大倍数
    private float mScaleTimes = 1.7f;
...
//        获得默认第一个view
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if ((new_y-old_y)==0||pressStartTime<200){
                    return true;
                }
                break;
            case MotionEvent.ACTION_UP:
                ...
                if ((new_y-old_y)==0||pressDuration<200){
                    return true;
                }
                break;
        }
    ...
    private boolean isCanPullUp() {
        return zoomView.getHeight() <getHeight() + getScrollY();
    }
